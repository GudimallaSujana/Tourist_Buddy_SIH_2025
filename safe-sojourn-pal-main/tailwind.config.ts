  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Guardian Buddy Colors
        monk: {
          primary: "hsl(var(--monk-primary))",
          secondary: "hsl(var(--monk-secondary))",
          accent: "hsl(var(--monk-accent))",
          background: "hsl(var(--monk-background))",
        },
        // Safety Colors
        safety: {
